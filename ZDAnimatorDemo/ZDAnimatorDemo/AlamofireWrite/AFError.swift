...
extension AFError.ResponseValidationFailureReason {
    var acceptableContentTypes: [String]? {
        ...
        case .missingContentType(acceptableContentTypes: let types),
             .unacceptableContentType(acceptableContentTypes: let types, responseContentType: _):
            return types
        default:
            return nil
        }
    ...
    var responseContentType: String? {
        switch self {
        case .unacceptableContentType(acceptableContentTypes: _, responseContentType: let responseType):
            return responseType
        default:
            return nil
        }
...
extension AFError.ResponseSerializationFailureReason {
    ...
    var underlyingError: Error? {
        switch self {
        case .jsonSerializationFailed(error: let error), .propertyListSerializationFailed(error: let error):
            return error
        default:
            return nil
        }
...
// MARK: - 错误描述 遵守LocalizedError协议 并且重写了errorDescription属性
...
extension AFError.ParameterEncodingFailureReason {
    var localizedDescription: String {
        ...
        case .propertyListEncodingFailed(error: let error):
